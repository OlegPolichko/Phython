...
message = f"{guest[3].title()} приходи сегодня вечером на обед"
print(message)
message = f"{guest[4].title()} приходи сегодня вечером на обед"
print(message)
message = f"{guest[5].title()} приходи сегодня вечером на обед"
print(message)
message = f"{guest[6].title()} приходи сегодня вечером на обед"
print(message)
...
while dlina>3:
    ...
    print(message)
message = f"{guest[0].title()} для вас предложение все еще в силе"
print(message)
message = f"{guest[1].title()} для вас предложение все еще в силе"
print(message)